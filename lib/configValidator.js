...
class ConfigValidator {
  ...
  validateVectorDb(config) {
    ...
    sanitized.vectorDbEnabled = Boolean(config.vectorDbEnabled);

    if (!sanitized.vectorDbEnabled) {
      warnings.push(
  ...
  validateToolServer(config) {
    ...
    sanitized.toolServerEnabled = Boolean(config.toolServerEnabled);

    if (!sanitized.toolServerEnabled) {
      warnings.push(
  ...
  validateDependencies(config) {
    ...
    if (config.toolServerEnabled && !config.vectorDbEnabled) {
